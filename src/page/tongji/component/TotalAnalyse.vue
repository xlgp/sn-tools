<template>
  <el-card class="box-card" id="totalCard">
    ...
    <el-table :data="totalAnalyse"  id="totalTable" data-clipboard-target="#totalCard" style="width: 100%" size="small">
...
<script lang="ts">
import { ComputedRef, defineComponent, inject, onMounted } from "vue";
