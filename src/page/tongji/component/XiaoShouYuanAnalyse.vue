<template>
  <el-card class="box-card" id="xsycard">
    ...
    <el-table :data="tableData" id="xsytable" data-clipboard-target="#xsycard" style="width: 100%" size="small" show-summary>
    ...
    const tableData: ComputedRef<ItemType[]> = computed(() => {
      let result: ResultType = {} as ResultType;
        if (dataList.value && dataList.value.length > 0) {
            dataList.value.sort((f, s) => f.xiaoshouyuan.localeCompare(s.xiaoshouyuan));
